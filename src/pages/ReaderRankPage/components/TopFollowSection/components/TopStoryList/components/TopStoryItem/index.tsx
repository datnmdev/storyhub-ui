        ...
        >
            ...
            <div className="grow flex justify-between space-x-4 shrink-0">
                ...
                <div className="grow flex flex-col justify-between">
                    ...
                    <div className="grow flex items-center space-x-1">
                        <span>{t("reader.rankPage.topFollowSection.topStoryList.item.followCount.label")}</span>
                        <span className="font-[450]">
                            {t("reader.rankPage.topFollowSection.topStoryList.item.followCount.content", { value: NumberUtils.formatNumberWithSeparator(String(data.followCount)) })}
                        </span>
                    </div>
                </div>
            </div>
